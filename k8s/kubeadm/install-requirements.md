...
- **Opção 1**: Use quando quiser uma instalação limpa ou houver problemas de configuração
  - Executa `kubeadm reset` para desmanchar o cluster
  - Encerra processos remanescentes (kube-apiserver, kubelet, etcd, etc.)
  - Aguarda liberação de portas (6443, etc.)
  - Desmonta volumes ativos
  - Remove interfaces de rede (cni0, flannel.1, docker0)
  ...
  - Limpa regras iptables do Kubernetes
